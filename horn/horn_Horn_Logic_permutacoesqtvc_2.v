...
Theorem permutacoes'vc :
          ...
          (let o := eq_pos1 result1 result in
           ...
           (let result2 := convertRStoAF p in
            ...
            (let o1 := set.Fset.add result2 c in
             ...
             list.Permut.permut o2 (removeFromList (s, p) clauselist2) /\
             list.Permut.permut (Init.Datatypes.app o2 o3) full_clauselist /\
             set.Fset.mem ATop o1 /\
             ~ set.Fset.mem ABot o1 /\
  ...
  (forall (result:set.Fset.fset atomicformula),
   match clauselist with
   ...
   | _ =>
       ...
       | Init.Datatypes.Some (s, p) =>
           ...
           (let o := eq_pos1 result2 result1 in
            ((o = Init.Datatypes.true) <-> (result2 = result1)) /\
            ((o = Init.Datatypes.true) /\ (result = (set.Fset.add ABot c)) \/
             ...
             (let result3 := convertRStoAF p in
              ...
              (let o1 := set.Fset.add result3 c in
               let o2 := removeFromList (s, p) clauselist in
               let o3 := Init.Datatypes.cons (s, p) processed_clauses in
               set.Fset.infix_eqeq (algorithmA_spec full_clauselist o3 o2 o1)
               (algorithmA_spec full_clauselist o3
                (removeFromList (s, p) clauselist2) o1) /\
               set.Fset.infix_eqeq result
               (algorithmA_spec full_clauselist o3 o2 o1)))))
       end
   end ->
   set.Fset.infix_eqeq
   (algorithmA_spec full_clauselist processed_clauses clauselist c)
