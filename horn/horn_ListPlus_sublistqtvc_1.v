...
(* Why3 goal *)
Theorem sublist'vc {a:Type} {a_WT:WhyType a} :
  forall (list1:Init.Datatypes.list a) (list2:Init.Datatypes.list a),
  forall (result:Init.Datatypes.bool),
  match list1 with
  | Init.Datatypes.nil => (result = Init.Datatypes.true)
  | Init.Datatypes.cons x l =>
      list.Mem.mem x list2 /\
      ((forall (elem:a), list.Mem.mem elem l -> list.Mem.mem elem list2) /\
       (result = Init.Datatypes.true) \/
       ~ (forall (elem:a), list.Mem.mem elem l -> list.Mem.mem elem list2) /\
       (result = Init.Datatypes.false)) \/
      ~ list.Mem.mem x list2 /\ (result = Init.Datatypes.false)
  end ->
  (result = Init.Datatypes.true) <->
