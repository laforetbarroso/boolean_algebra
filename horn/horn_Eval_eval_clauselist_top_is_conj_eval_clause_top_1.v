...
Axiom H : ((eval_clauselist cl f) = top).

Parameter c: (set.Fset.fset atomicformula* rightside)%type.

Axiom H1 : list.Mem.mem c cl.

(* Why3 goal *)
Theorem eval_clauselist_top_is_conj_eval_clause_top :
  (match c with
   | (setc, p) =>
       infix_mngtas (eval_setconjunction setc f)
       (eval_rightside (assign_rightside p f))
