  ...
  | _ =>
      ...
      | Init.Datatypes.Some (s, p) =>
          ...
          (let o := eq_pos1 result1 result in
           ...
           (let o1 := removeFromList (s, p) clauselist in
            let o2 := Init.Datatypes.cons (s, p) processed_clauses in
            ...
            (let o3 := set.Fset.add result2 d in
             ...
             (let o4 := set.Fset.add result3 c in
              ((0%Z <= (list.Length.length clauselist))%Z /\
               ((list.Length.length o1) < (list.Length.length clauselist))%Z) /\
              set.Fset.mem ATop o4 /\
              ~ set.Fset.mem ABot o3 /\
              set.Fset.subset o4 o3 /\
              sublist o1 full_clauselist /\
              list.Permut.permut (Init.Datatypes.app o1 o2) full_clauselist /\
              set.Fset.subset o3
              (set.Fset.add ATop (set_smb_clauselist full_clauselist)) /\
              (forall (f:i -> b),
               ((eval_clauselist full_clauselist f) = top) ->
               ((eval_setconjunction o3 f) = top)) /\
              (forall (f:i -> b),
               ((eval_clauselist o2 f) = top) <->
               ((eval_setconjunction o4 f) = top)) /\
              (forall (f:i -> b),
               ((eval_clauselist o2 f) = top) <->
               ((eval_setconjunction o3 f) = top))))))
      end
            ...
            ((o = Init.Datatypes.true) \/
             (let o1 := removeFromList (s, p) clauselist in
              ...
              (let result3 := convertRStoAF p in
               ...
               set.Fset.subset
               (algorithmA_spec full_clauselist o2 o1
                (set.Fset.add result3 c))
               (algorithmA_spec full_clauselist o2 o1
                (set.Fset.add result2 d))))))
       end
   end ->
   set.Fset.subset
   (algorithmA_spec full_clauselist processed_clauses clauselist c)
