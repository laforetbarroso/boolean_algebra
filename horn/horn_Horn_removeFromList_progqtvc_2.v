...
Parameter p: rightside.

Parameter clauselist: Init.Datatypes.list (set* rightside)%type.

Parameter result: Init.Datatypes.list (set* rightside)%type.

Parameter result1: Init.Datatypes.list (set* rightside)%type.

Parameter x: Init.Datatypes.list (set* rightside)%type.

Parameter x1: set.

Parameter x2: rightside.

Axiom H : (clauselist = (Init.Datatypes.cons (x1, x2) x)).

Parameter if_term: Init.Datatypes.bool.

Axiom if_term'def :
  (set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term = (rs_eq_pos x2 p))) /\
  (~ set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term = Init.Datatypes.false)).

Axiom H1 : ~ (if_term = Init.Datatypes.true).

Parameter if_term1: Init.Datatypes.bool.

Axiom if_term'def1 :
  (set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term1 = (rs_eq_pos x2 p))) /\
  (~ set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term1 = Init.Datatypes.false)).

Axiom H2 : ~ (x2 = p).

Parameter if_term2: Init.Datatypes.bool.

Axiom if_term'def2 :
  (set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term2 = (rs_eq_pos x2 p))) /\
  (~ set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term2 = Init.Datatypes.false)).

Axiom H3 : ~ (if_term2 = Init.Datatypes.true).

Parameter if_term3: Init.Datatypes.bool.

Axiom if_term'def3 :
  (set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term3 = (rs_eq_pos x2 p))) /\
  (~ set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term3 = Init.Datatypes.false)).

Axiom H4 :
  ((listset_to_listfset result1) =
   (removeFromList (to_fset set1, p) (listset_to_listfset x))).

Parameter if_term4: Init.Datatypes.bool.

Axiom if_term'def4 :
  (set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term4 = (rs_eq_pos x2 p))) /\
  (~ set.Fset.infix_eqeq (to_fset x1) (to_fset set1) ->
   (if_term4 = Init.Datatypes.false)).

Axiom H5 : (result = (Init.Datatypes.cons (x1, x2) result1)).

(* Why3 goal *)
Theorem removeFromList_prog'vc :
  ((listset_to_listfset result) =
   (removeFromList (to_fset set1, p) (listset_to_listfset clauselist))).
