...
(* Why3 goal *)
Theorem is_equal_list_reflexive'vc {a:Type} {a_WT:WhyType a} :
  forall (l1:Init.Datatypes.list a),
  match l1 with
  | Init.Datatypes.nil => True
  | Init.Datatypes.cons x ls => True
  end /\
  (match l1 with
   | Init.Datatypes.nil => True
   | Init.Datatypes.cons x ls => is_equal_list ls ls
   end -> is_equal_list l1 l1).
