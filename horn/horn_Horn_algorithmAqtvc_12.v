...
Parameter to_fset: set -> set.Fset.fset atomicformula.

Parameter mk: set.Fset.fset atomicformula -> set.

Axiom mk'spec :
  forall (s:set.Fset.fset atomicformula), ((to_fset (mk s)) = s).

Parameter choose: set -> atomicformula.
  ...
  | _ =>
      ...
      | Init.Datatypes.None =>
          ((algorithmA_spec full_clauselist processed_clauses clauselist c) =
           c)
      | Init.Datatypes.Some (s, p) =>
          (((eq_pos1 (convertRStoAF p) ABot) = Init.Datatypes.true) ->
           ((algorithmA_spec full_clauselist processed_clauses clauselist c)
            = (set.Fset.add ABot c))) /\
          (~ ((eq_pos1 (convertRStoAF p) ABot) = Init.Datatypes.true) ->
           ((algorithmA_spec full_clauselist processed_clauses clauselist c)
            ...
            (algorithmA_spec full_clauselist
             (Init.Datatypes.cons (s, p) processed_clauses)
             (removeFromList (s, p) clauselist)
             (set.Fset.add (convertRStoAF p) c))))
      end
  end.
...
Axiom monotone_algA :
  forall (c:set.Fset.fset atomicformula) (d:set.Fset.fset atomicformula)
    ...
    (clauselist:
     Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type),
  set.Fset.mem ATop c -> ~ set.Fset.mem ABot d -> set.Fset.subset c d ->
  sublist clauselist full_clauselist ->
  list.Permut.permut (Init.Datatypes.app clauselist processed_clauses)
  full_clauselist ->
  ...
  set.Fset.subset
  (algorithmA_spec full_clauselist processed_clauses clauselist c)
  (algorithmA_spec full_clauselist processed_clauses clauselist d).
...
Axiom smb :
  ...
  clauselist ->
  set.Fset.subset c
  (set.Fset.add ATop (set.Fset.add ABot (set_smb_clauselist clauselist))) ->
  (forall (f:i -> b), ((eval_clauselist clauselist f) = top) ->
   ((eval_setconjunction c f) = top)) ->
  (forall (f:i -> b),
   ((eval_clauselist processed_clauses f) = top) <->
   ((eval_setconjunction c f) = top)) ->
  set.Fset.subset (algorithmA_spec clauselist processed_clauses clauselist c)
  (set.Fset.add ATop (set.Fset.add ABot (set_smb_clauselist clauselist))).

Axiom unsat_cl_mem_ABot_in_algorithmA :
  forall (full_clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (processed_clauses:
     Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (clauselist:
     Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (c:set.Fset.fset atomicformula),
  is_unsatisfiable_clauselist full_clauselist ->
  list.Permut.permut (Init.Datatypes.app processed_clauses clauselist)
  full_clauselist -> sublist clauselist full_clauselist ->
  set.Fset.subset c (set.Fset.add ATop (set_smb_clauselist full_clauselist)) ->
  is_satisfiable_clauselist processed_clauses ->
  (forall (f:i -> b), ((eval_clauselist full_clauselist f) = top) ->
   ((eval_setconjunction c f) = top)) ->
...
Axiom not_mem_ABot_then_cl_sat :
  forall (clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type),
  ~ set.Fset.mem ABot
    (algorithmA_spec clauselist Init.Datatypes.nil clauselist
     (set.Fset.add ATop (set.Fset.empty : set.Fset.fset atomicformula))) ->
  is_satisfiable_clauselist clauselist.

Axiom sat_cl_not_ABot_in_algorithmA :
  forall (full_clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (processed_clauses:
     Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (clauselist:
     Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (c:set.Fset.fset atomicformula),
  is_satisfiable_clauselist full_clauselist ->
  list.Permut.permut (Init.Datatypes.app processed_clauses clauselist)
  full_clauselist -> sublist clauselist full_clauselist ->
  set.Fset.subset c (set.Fset.add ATop (set_smb_clauselist full_clauselist)) ->
  (forall (f:i -> b), ((eval_clauselist full_clauselist f) = top) ->
...
Parameter horn_logic:
  Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type ->
  Init.Datatypes.bool.

Axiom horn_logic'def :
  forall (clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type),
  (~ set.Fset.mem ABot
     (algorithmA_spec clauselist Init.Datatypes.nil clauselist
      (set.Fset.add ATop (set.Fset.empty : set.Fset.fset atomicformula))) ->
   ((horn_logic clauselist) = Init.Datatypes.true)) /\
  (set.Fset.mem ABot
   (algorithmA_spec clauselist Init.Datatypes.nil clauselist
    (set.Fset.add ATop (set.Fset.empty : set.Fset.fset atomicformula))) ->
   ((horn_logic clauselist) = Init.Datatypes.false)).

Axiom horn_sat_completeness :
  forall (clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type),
  is_satisfiable_clauselist clauselist ->
  ((horn_logic clauselist) = Init.Datatypes.true).

Axiom horn_unsat_completeness :
  forall (clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type),
  is_unsatisfiable_clauselist clauselist ->
  ((horn_logic clauselist) = Init.Datatypes.false).
...
(* Why3 assumption *)
Fixpoint listset_to_listfset
  (clauselist:Init.Datatypes.list (set* rightside)%type) {struct clauselist}: 
  Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type :=
  match clauselist with
  | Init.Datatypes.nil => Init.Datatypes.nil
  | Init.Datatypes.cons (setc, p) l =>
      Init.Datatypes.cons (to_fset setc, p) (listset_to_listfset l)
  end.

Axiom length_equal_listset_to_list_fset :
  forall (cl:Init.Datatypes.list (set* rightside)%type),
  ((list.Length.length cl) = (list.Length.length (listset_to_listfset cl))).

(* Why3 assumption *)
Fixpoint listfset_to_listset
  (clauselist:
   Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type) {struct clauselist}: 
  Init.Datatypes.list (set* rightside)%type :=
  match clauselist with
  | Init.Datatypes.nil => Init.Datatypes.nil
  | Init.Datatypes.cons (setc, p) l =>
      Init.Datatypes.cons (mk setc, p) (listfset_to_listset l)
  end.

(* Why3 goal *)
Theorem algorithmA'vc :
  forall (full_clauselist:
          Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (processed_clauses:
     Init.Datatypes.list (set.Fset.fset atomicformula* rightside)%type)
    (clauselist:Init.Datatypes.list (set* rightside)%type) (c:set),
  set.Fset.mem ATop (to_fset c) /\
  ~ set.Fset.mem ABot (to_fset c) /\
  sublist (listset_to_listfset clauselist) full_clauselist /\
  list.Permut.permut
  (Init.Datatypes.app (listset_to_listfset clauselist) processed_clauses)
  full_clauselist /\
  set.Fset.subset (to_fset c)
  (set.Fset.add ATop (set_smb_clauselist full_clauselist)) /\
  is_satisfiable_clauselist processed_clauses /\
  (forall (f:i -> b), ((eval_clauselist full_clauselist f) = top) ->
   ((eval_setconjunction (to_fset c) f) = top)) /\
  (forall (f:i -> b),
   ((eval_clauselist processed_clauses f) = top) <->
   ((eval_setconjunction (to_fset c) f) = top)) ->
  match clauselist with
  | Init.Datatypes.nil => True
  | _ =>
      forall (o:Init.Datatypes.option (set* rightside)%type),
      match o with
      | Init.Datatypes.None =>
          match findOneSubset (listset_to_listfset clauselist) (to_fset c) with
          | Init.Datatypes.None => True
          | Init.Datatypes.Some _ => False
          end
      | Init.Datatypes.Some (setc, p) =>
          ((Init.Datatypes.Some (to_fset setc, p)) =
           (findOneSubset (listset_to_listfset clauselist) (to_fset c)))
      end ->
      match o with
      | Init.Datatypes.None => True
      | Init.Datatypes.Some (s, p) =>
          let result := ABot in
          let result1 := convertRStoAF p in
          (forall (f:i -> b),
           ((eval_rightside (assign_rightside p f)) =
            (eval_atomicformula result1 f))) /\
          match p with
          | RProp t =>
              (t = top) /\ (result1 = ATop) \/
              ~ (t = top) /\ (result1 = ABot)
          | RVar x => (result1 = (AVar x))
          end ->
          (let o1 := eq_pos1 result1 result in
           (o1 = Init.Datatypes.true) <-> (result1 = result) ->
           ~ (o1 = Init.Datatypes.true) ->
           (let result2 := convertRStoAF p in
            (forall (f:i -> b),
             ((eval_rightside (assign_rightside p f)) =
              (eval_atomicformula result2 f))) /\
            match p with
            | RProp t =>
                (t = top) /\ (result2 = ATop) \/
                ~ (t = top) /\ (result2 = ABot)
            | RVar x => (result2 = (AVar x))
            end ->
            (forall (o2:set),
             ((to_fset o2) = (set.Fset.add result2 (to_fset c))) /\
             (set.Fset.mem result2 (to_fset c) /\
              ((set.Fset.cardinal (to_fset o2)) =
               (set.Fset.cardinal (to_fset c))) \/
              ~ set.Fset.mem result2 (to_fset c) /\
              ((set.Fset.cardinal (to_fset o2)) =
               ((set.Fset.cardinal (to_fset c)) + 1%Z)%Z)) ->
             (forall (o3:Init.Datatypes.list (set* rightside)%type),
              ((listset_to_listfset o3) =
               (removeFromList (to_fset s, p)
                (listset_to_listfset clauselist))) ->
              (let o4 :=
               Init.Datatypes.cons (to_fset s, p) processed_clauses in
               ((0%Z <= (list.Length.length clauselist))%Z /\
                ((list.Length.length o3) < (list.Length.length clauselist))%Z) /\
               set.Fset.mem ATop (to_fset o2) /\
               ~ set.Fset.mem ABot (to_fset o2) /\
               sublist (listset_to_listfset o3) full_clauselist /\
               list.Permut.permut
               (Init.Datatypes.app (listset_to_listfset o3) o4)
               full_clauselist /\
               set.Fset.subset (to_fset o2)
               (set.Fset.add ATop (set_smb_clauselist full_clauselist)) /\
               is_satisfiable_clauselist o4 /\
               (forall (f:i -> b),
                ((eval_clauselist full_clauselist f) = top) ->
                ((eval_setconjunction (to_fset o2) f) = top)) /\
               (forall (f:i -> b),
                ((eval_clauselist o4 f) = top) <->
                ((eval_setconjunction (to_fset o2) f) = top)))))))
      end
  end /\
  (forall (result:set),
   match clauselist with
   | Init.Datatypes.nil => (result = c)
   | _ =>
       exists o:Init.Datatypes.option (set* rightside)%type,
       match o with
       | Init.Datatypes.None =>
           match findOneSubset (listset_to_listfset clauselist) (to_fset c) with
           | Init.Datatypes.None => True
       ...
       | Init.Datatypes.Some (s, p) =>
           ...
           (let o1 := eq_pos1 result2 result1 in
            ((o1 = Init.Datatypes.true) <-> (result2 = result1)) /\
            ((o1 = Init.Datatypes.true) /\
             (let result3 := ABot in
              ((to_fset result) = (set.Fset.add result3 (to_fset c))) /\
              (set.Fset.mem result3 (to_fset c) /\
               ((set.Fset.cardinal (to_fset result)) =
                (set.Fset.cardinal (to_fset c))) \/
               ~ set.Fset.mem result3 (to_fset c) /\
               ((set.Fset.cardinal (to_fset result)) =
                ((set.Fset.cardinal (to_fset c)) + 1%Z)%Z))) \/
             ~ (o1 = Init.Datatypes.true) /\
             (let result3 := convertRStoAF p in
              ((forall (f:i -> b),
                ((eval_rightside (assign_rightside p f)) =
                 (eval_atomicformula result3 f))) /\
               match p with
               | RProp t =>
                   (t = top) /\ (result3 = ATop) \/
                   ~ (t = top) /\ (result3 = ABot)
               | RVar x => (result3 = (AVar x))
               end) /\
              (exists o2:set,
               (((to_fset o2) = (set.Fset.add result3 (to_fset c))) /\
                (set.Fset.mem result3 (to_fset c) /\
                 ((set.Fset.cardinal (to_fset o2)) =
                  (set.Fset.cardinal (to_fset c))) \/
                 ~ set.Fset.mem result3 (to_fset c) /\
                 ((set.Fset.cardinal (to_fset o2)) =
                  ((set.Fset.cardinal (to_fset c)) + 1%Z)%Z))) /\
               (exists o3:Init.Datatypes.list (set* rightside)%type,
                ((listset_to_listfset o3) =
                 (removeFromList (to_fset s, p)
                  (listset_to_listfset clauselist))) /\
                ((to_fset result) =
                 (algorithmA_spec full_clauselist
                  (Init.Datatypes.cons (to_fset s, p) processed_clauses)
                  (listset_to_listfset o3) (to_fset o2))))))))
       end
   end ->
   ((to_fset result) =
    (algorithmA_spec full_clauselist processed_clauses
     (listset_to_listfset clauselist) (to_fset c)))).
