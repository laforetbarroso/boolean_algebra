...
Axiom Requires1 : ~ set.Fset.mem ABot c.
...
Axiom Requires6 : is_satisfiable_clauselist processed_clauses.
...
Axiom H5 : ((eq_pos1 (convertRStoAF x1) ABot) = Init.Datatypes.true).

Axiom H6 : (result = (set.Fset.add ABot c)).

Axiom Ensures : set.Fset.subset c result.
...
Axiom H7 : ((eval_clauselist full_clauselist f) = top).

(* Why3 goal *)
Theorem algorithmA_spec'vc : ((eval_setconjunction result f) = top).
