...
Axiom H2 : is_cnf_clause phi.

Parameter result: Init.Datatypes.list atom.

Parameter result1: Init.Datatypes.list atom.

Parameter result2: Init.Datatypes.list atom.

Parameter x: formula.

Parameter x1: formula.

Axiom H3 : (phi = (Or x x1)).

Axiom Ensures :
  forall (v:i -> b), ((eval x1 v) = (eval_cnf_clause result1 v)).

Axiom Ensures1 :
  forall (v:i -> b), ((eval x v) = (eval_cnf_clause result2 v)).
...
(* Why3 goal *)
Theorem to_cnf_aux'vc : ((eval phi v) = (eval_cnf_clause result v)).
